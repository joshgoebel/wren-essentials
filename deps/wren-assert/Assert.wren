...
class Assert {
  ...
  static arrayEqual(actual, expected) {
    arrayEqual(actual, expected, "Expected equality: %(actual) != %(expected)")
  }
  ...
  static not(value) {
    not(value, "Expected input to not be ok: %(value)")
  }

  static not(value, message) {
